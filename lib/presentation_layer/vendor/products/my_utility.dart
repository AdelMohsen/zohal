...
class MyUtil {
  ...
  // static String loginFlow(int userType) {
  //   switch (userType) {
  //     case 0:
  //       return WebAdminDashboard.routeName;
  //     case 2:
  //       return WebVendorDashboard.routeName;
  //     default:
  //       return WebLogin.routeName;
  //   }
  // }
  ...
  // static bool isEnglish(Auth auth) =>
  //     auth.language.toString() == 'EN' || auth.language.toString() == '';
