...
class ChatWithVendorScreen extends StatelessWidget {
  const ChatWithVendorScreen({Key? key}) : super(key: key);
                    ...
                    children: [
                      Align(
                        ...
                        child: Container(
                          ...
                          child: const Text(
                              'vendor with you how i can help you ...?'),
                        ),
                      ),
                      Align(
                        ...
                        child: Container(
                          ...
                          decoration: const BoxDecoration(
                              ...
                              borderRadius: BorderRadiusDirectional.only(
                                  ...
                                  topEnd: Radius.circular(10.0),
                                  topStart: Radius.circular(10.0))),
                          child: const Text('i need to buy your products ....'),
                        ),
                      ),
                    ],
                  ),
